...
- part - header
- regex
  1. wordpress\_[a-z0-9]+=([A-Za-z0-9%]+)
...
- WordPress plugin sitepress-multilingual-cms 3.6.3 is vulnerable to cross-site scripting in process*forms via any locale_file_name* parameter (such as locale_file_name_en) in an authenticated theme-localization.php request to wp-admin/admin.php.
- severity - medium
