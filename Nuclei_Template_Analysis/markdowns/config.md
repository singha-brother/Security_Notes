...
- part - body
- regex
    1. (?mi)^APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)=
    2. (?mi)^DB_(HOST|PASSWORD|DATABASE)=
- condition - or
...
**Type - regex**
- regex
    1. (?m)^APP_(NAME|ENV|KEY|DEBUG|URL|PASSWORD)
    2. (?m)^DB_(HOST|PASSWORD|DATABASE)
- condition - or
...
**Type - regex**
- regex
    1. "role":"super_admin","name":"(.*)","password":"(.*)"
- part - body
- condition - and
